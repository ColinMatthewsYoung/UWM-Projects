...
public class TestDictionary extends TestCase {
	...
	public void test67() {
		...
		dict.put(n("CS-417"),"Dumitrescu");
		dict.put(n("CS-458"),"Hosseini");
		dict.put(n("CS-422"),"Mali");
		dict.put(n("CS-535"),"Suzuki");
		...
		assertEquals("/CS-417",pieces[2]);
		assertEquals("Dumitrescu",pieces[3]);
		...
		assertEquals("Hosseini",pieces[9]);
		assertEquals("/CS-469",pieces[10]);
		assertEquals("Xu",pieces[11]);
		assertEquals("/CS-535",pieces[12]);
		assertEquals("Suzuki",pieces[13]);
	}
